...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="h-screen flex items-center pt-16 sm:pt-24 relative overflow-hidden">
      ...
      <div className="container-custom mx-auto px-4 sm:px-6">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-3 sm:mb-4 leading-tight sm:leading-[1.2]">
